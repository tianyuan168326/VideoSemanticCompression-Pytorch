...
class BaseHead(nn.Module, metaclass=ABCMeta):
    ...
    def loss(self, cls_score111, labels, **kwargs):
        ...
        """
        cls_score =  cls_score111["cls_score"] ### the first is score
        h265_bitcosts =  cls_score111['h265_bitcosts'] ### the first is score
        code_bpp =  cls_score111['code_bpp'] ### the first is score
        ...
        # losses["loss_code_bpp"] = 1024 * code_bpp.mean()/(b*8*224*224)
        # losses["h265_bpp"] = h265_bpp.mean()*0
        return losses
