...
class RawframeDataset(BaseDataset):
	...
	Args:
		...
		data_prefix (str | None): Path to a directory where videos are held.
			Default: None.
		data_prefix_compress (str | None): Path to a directory where videos are held.
			Default: None.
	...
	def __init__(self,
		...
		self.data_prefix_compress = data_prefix_compress
		# print(self.data_prefix_compress)
		# exit()
		...
		with open(self.ann_file, 'r') as fin:
			for line in fin:
				...
				if self.data_prefix is not None:
					# import random
					# frame_dir = osp.join(random.choice([self.data_prefix,
					# "/data_video/ucf101_jpg_h265_crf43/ucf101_jpg"]), frame_dir)
					frame_dir = osp.join(self.data_prefix, frame_dir)
					# print(frame_dir)
					frame_dir_compress = osp.join(self.data_prefix_compress, frame_dir)
				video_info['frame_dir'] = frame_dir
				video_info['frame_dir_compress'] = frame_dir_compress
				idx += 1
				if self.with_offset:
