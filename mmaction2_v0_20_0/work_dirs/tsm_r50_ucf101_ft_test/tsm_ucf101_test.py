model = dict(
    ...
    backbone=dict(
        ...
        '/data_video/code/lbvu/checkpoints/ablations_studies/train_vqgan_l4_seg_2dgan_wotrans0/checkpoint/action_backbone.TSM_k60k_brrand_resnet50_segment8__best_network.pth.tar'
    ),
    cls_head=dict(
        type='TSMHead',
        num_classes=101,
...
work_dir = './work_dirs/tsm_r50_ucf101_ft_test/'
gpu_ids = range(0, 6)
omnisource = False
module_hooks = []
