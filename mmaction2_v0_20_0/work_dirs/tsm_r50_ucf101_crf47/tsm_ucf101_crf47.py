...
data_root = '/data_video/ucf101_jpg_crf47/ucf101_jpg/'
data_root_val = '/data_video/ucf101_jpg_crf47/ucf101_jpg/'
...
data = dict(
    ...
    train=dict(
        ...
        data_prefix='/data_video/ucf101_jpg_crf47/ucf101_jpg/',
...
work_dir = './work_dirs/tsm_r50_ucf101_crf47/'
gpu_ids = range(0, 6)
omnisource = False
module_hooks = []
