...
def parse_hmdb51_split(level):
    train_file_template = '/data_video/code/lbvu/mmaction/tools/data/hmdb51/annotations/trainlist{:02d}.txt'
    test_file_template = '/data_video/code/lbvu/mmaction/tools/data/hmdb51/annotations/testlist{:02d}.txt'
    class_index_file = '/data_video/code/lbvu/mmaction/tools/data/hmdb51/annotations/classInd.txt'
    ...
    def generate_class_index_file():
        ...
        frame_path = '/data_video/hmdb51_extracted'
        annotation_dir = '/data_video/code/lbvu/mmaction/tools/data/hmdb51/annotations'
