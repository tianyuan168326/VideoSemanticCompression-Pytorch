...
# model settings
model = dict(cls_head=dict(num_classes=51, num_segments=16),
...
load_from = 'https://download.openmmlab.com/mmaction/recognition/tsm/tsm_k400_pretrained_r50_1x1x16_25e_hmdb51_rgb/tsm_k400_pretrained_r50_1x1x16_25e_hmdb51_rgb_20210630-4785548e.pth'  # noqa: E501
# runtime settings
