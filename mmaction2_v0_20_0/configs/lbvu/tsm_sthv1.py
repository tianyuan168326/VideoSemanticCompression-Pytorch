...
# model settings
model = dict(cls_head=dict(num_classes=174),backbone=dict(test_mode = 'hd'))
...
ann_file_test = '/data_video/code/lbvu/mmaction/tools/data/sthv1/sthv1_val_list_rawframes.txt'
img_norm_cfg = dict(
...
##https://download.openmmlab.com/mmaction/recognition/tsm/tsm_r50_flip_randaugment_1x1x8_50e_sthv1_rgb/tsm_r50_flip_randaugment_1x1x8_50e_sthv1_rgb_20210324-76937692.pth