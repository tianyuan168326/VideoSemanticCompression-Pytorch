...
with zipfile.ZipFile('/data_video/davis2017/DAVIS-2017-trainval-480p.zip', 'r') as zip_file:
    zip_file.extractall('/data_video/davis2017/DAVIS/2017/')
with zipfile.ZipFile('/data_video/davis2017/DAVIS-2017-scribbles-trainval.zip', 'r') as zip_file:
    zip_file.extractall('/data_video/davis2017/DAVIS/2017/')
os.rename('/data_video/davis2017/DAVIS/2017/', '/data_video/davis2017/DAVIS/trainval/')
