...
class XMem(nn.Module):
    def __init__(self, config, model_path=None, map_location=None):
        ...
        self.quantization_m  = 0
        # self.quantization_m = Quantization_H265(q = config.get('test_compress_q'),
        #     type = 'h266',\
        #     scale_times_in  = 1,
        #     scale_times_out  = 1,
        #     tune = "zerolatency",keyint = 10,codec_config_file = "")
        self.key_encoder = KeyEncoder(self.quantization_m)
        self.value_encoder = ValueEncoder(self.value_dim, self.hidden_dim,self.quantization_m,self.single_object)
        ...
        self.feature_buffer_v  = []
        

    def encode_key(self, frame,feature_index_id, need_sk=True, need_ek=True): 
        ...
        f16, f8, f4,bpp_k_frame= self.key_encoder(frame,feature_index_id)
        ...
        return key, shrinkage, selection, f16, f8, f4,bpp_k_frame

    def encode_value(self, frame, feature_index, image_feat_f16, h16, masks, is_deep_update=True): 
        ...
        g16, h16,bpp_v = self.value_encoder(frame, feature_index,image_feat_f16, h16, masks, others, is_deep_update)

        return g16, h16,bpp_v
